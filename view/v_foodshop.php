	...
	<div class="col-md-3" style="margin-top: 20px;padding-bottom: 20px; border-bottom: 1px solid #CCCCCC;">	
		<div id="border">
			<p style="color: red; font-weight: bold; font-size: 18px;">SẢN	 PHẨM MỚI NHẤT</p>
		</div>
	</div>
</div>
</div>
