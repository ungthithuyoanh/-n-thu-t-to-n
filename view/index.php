					...
					<form  method="POST">
						<label>
							<!-- <a href="../controller/c_index.php?diachi=null"> -->
								<input class="diachi" type="radio" name="diachi" checked>
								<span>Tất cả</span>
							<!-- </a> -->
						</label>
						<br>
						<label>
							<!-- <a href="../controller/c_index.php?diachi=hải châu"> -->
								<input type="radio" class="diachi" name="diachi" value="hai chau">
								<span>Hải Châu</span>
							<!-- </a> -->
						</label>
						<br>
						<label>
							<input type="radio" class="diachi" name="diachi" value="lien chieu">
							<span>Liên Chiểu</span>
						</label>
						<br>
						<label>
							<input type="radio" class="diachi"  name="diachi" value="cam le">		
							<span>Cẩm Lệ</span>
						</label>
						<br>
						<label>
							<input type="radio" class="diachi"  name="diachi" value="thanh khe">
							<span>Thanh Khê</span>
						</label>
					</form>
				</div>
...
<!-- <script type="text/javascript" charset="utf-8" async defer>
	$('.diachi').click(function(){
		...
		$.ajax({
			...
			error:function(){
				console.log("loi ajax c_foodshop");
			}
		});
	});
</script> -->
